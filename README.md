...
This project is intended to parse Vedic Suktas and other Sanskrit Texts with the purposes of discovering quantifiable linguistic patterns and paradigms for evaluations and comparisons. 

Sanskritists and Academics alike take note of linguistic patterns within Indian Religious Poetry, and make claim to them corresponding to Theological thought - whether Theologians and Practictioners of the traditions accept such interpretations is up in the air, although such analysis does not detract from the claims of Śruti and Apauruṣeya - arguably, it favors them. Thus this project is intended to serve the interests of both Theologian-Practictioners and Scholars alike, providing the tools to reveal patterns in the manifested hymnology of the Veda.  
...
- "the vowels _a_, _i_, _u_ and a single icon each of the oppositions of quantity (_a_ : _ā_) and nasalization (_a_ :_aṃ_)"
- "a single sibilant _ś_"
- "a single liquid _r_"
- "a single semi-vowel (glide) _v_"
- "a single nasal _m_"
- "and a single order of stops, _t_ _d_ _dh_ as tokens of the oppositions of voicing (_t_ : _d_) and aspiration or murmur (_d_ : _dh_)."[^1]
