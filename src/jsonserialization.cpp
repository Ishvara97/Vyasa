...
json verseSimilarityToJson(const VerseSimilarityComparison& comparison) {
    return {
        ...
        {"devLevenshteinDistance", comparison.devLevenshteinDistance},
        {"devLevenshteinSimilarity", comparison.devLevenshteinSimilarity},
        {"iastLevenshteinDistance", comparison.iastLevenshteinDistance},
        {"iastLevenshteinSimilarity", comparison.iastLevenshteinSimilarity},
